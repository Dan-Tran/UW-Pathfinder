...
public class HW5TestDriver {
    ...
    private void listNodes(String graphName) {
        ...
        if (graph.numNodes() == 0) {
            ...
            output.println(graphName + " contains: " + graph.nodesToString());
        }
    }
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        Graph<String, String> graph = graphs.get(graphName);
        String children = graph.childrenToString(parentName);
        if (children.isEmpty()) {
            output.println("the children of " + parentName + " in " + graphName + " are:");
        } else {
            output.println("the children of " + parentName + " in " + graphName + " are: " + graph.childrenToString(parentName));
        }
    }
